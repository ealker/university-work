...
If another function accesses `p` before data has been written, the pre-existing data in the 8 bytes of allocated memory could be passed to the function causing the program to behave unpredictably. 
